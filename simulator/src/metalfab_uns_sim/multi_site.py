...
class SemanticPublisher:
    ...
    def __init__(self, broker: str = "localhost", port: int = 1883, use_tls: bool = False, username: str = "", password: str = ""):
        self.broker = broker
        self.port = port
        ...
        if use_tls:
            ...
            logger.info("TLS enabled for SemanticPublisher")
...
class MultiSiteSimulator:
    ...
    def __init__(self, broker: str = "localhost", port: int = 1883, level: int = 2, use_tls: bool = False, username: str = "", password: str = ""):
        self.publisher = SemanticPublisher(broker, port, use_tls=use_tls, username=username, password=password)
...
def run_multi_site(
    ...
    sim = MultiSiteSimulator(broker, port, level, use_tls=use_tls, username=username, password=password)
